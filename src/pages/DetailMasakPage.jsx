        ...
        {steps.length === 0 ? (
          ...
          steps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className={`w-10 h-10 md:w-14 md:h-14 rounded-[12px] flex items-center justify-center shrink-0 text-xl md:text-2xl font-semibold transition ${
                  done ? "bg-[#f5c5ac] text-[#d06224]/50" : "bg-[#d06224] text-white"
                }`}>
                  {step.id}
                </div>
                <p className={`flex-1 text-base font-medium leading-relaxed transition capitalize ${
