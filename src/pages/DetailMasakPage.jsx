...
export default function DetailMasakPage() {
  ...
  const steps = [
    { id: 1, text: "Petik bayam, siapkan MSG dan bumbu iris" },
    { id: 2, text: "Potong tahu sesuai selera lalu goreng hingga matang" },
    { id: 3, text: "Tumis bawang hingga haru tambahkan Sasa Msg aduk rata, masukkan bayam aduk hingga layu tambahkan cabe aduk rata" },
    { id: 4, text: "Masukkan tahu dan sedikit air, tambahkan saus tiram, gula dan garam secukupnya aduk rata tes rasa, masak hingga matang dan bumbu meresap, matikan api" },
    { id: 5, text: "Sajikan hangat" },
  ];

  const [checkedSteps, setCheckedSteps] = useState(steps.map((_, i) => i === 0));
