...
export default function BahanLengkapPage() {
  ...
  const INITIAL_FAVORITE_MENUS = [
    { id: 1, title: "Tumis Bayam Tahu",    time: "30 Menit", portion: "2 Porsi", ingredients: ["Bayam", "Tahu"],  image: food7,  available: true, isFavorite: true },
    { id: 5, title: "Sambal Goreng Tempe", time: "45 Menit", portion: "1 Porsi", ingredients: ["Tempe", "Cabe"], image: food10, available: true, isFavorite: true },
  ];

  const INITIAL_ALL_MENUS = [
    { id: 6,  title: "Sate Ayam",    time: "60 Menit", portion: "2 Porsi", ingredients: ["Ayam"],           image: food7,  available: true, isFavorite: false },
    { id: 7,  title: "Telur Balado", time: "45 Menit", portion: "1 Porsi", ingredients: ["Telur", "Cabe"],  image: food8,  available: true, isFavorite: false },
    { id: 8,  title: "Sup Ayam",     time: "45 Menit", portion: "1 Porsi", ingredients: ["Ayam", "Wortel"], image: food9,  available: true, isFavorite: false },
    { id: 10, title: "Tumis Tahu",   time: "20 Menit", portion: "2 Porsi", ingredients: ["Tahu", "Kol"],    image: food10, available: true, isFavorite: false },
    { id: 12, title: "Sambal Tempe", time: "30 Menit", portion: "1 Porsi", ingredients: ["Tempe"],          image: food10, available: true, isFavorite: false },
    { id: 13, title: "Sup Bayam",    time: "20 Menit", portion: "2 Porsi", ingredients: ["Bayam"],          image: food7,  available: true, isFavorite: false },
    { id: 14, title: "Telur Ceplok", time: "10 Menit", portion: "1 Porsi", ingredients: ["Telur"],          image: food8,  available: true, isFavorite: false },
  ];
  ...
  const RecipeCard = ({ recipe }) => (
    <article className="relative h-[220px] cursor-pointer" onClick={() => navigate(`/detail-resep/${recipe.id}`)}>
      <img src={recipe.image} alt={recipe.title} className="absolute top-0 left-0 w-full h-[215px] object-cover rounded-[12px]" />
      ...
      <button
        ...
        className="absolute top-[155px] right-[32px] p-1"
      >
  ...
  return (
    <div className="flex min-h-screen bg-[#f4f4f4]">
      <aside className="fixed left-0 top-0 w-[110px] h-screen bg-white shadow-lg flex flex-col items-center py-5 gap-7 z-50">
        ...
        <div className="mt-auto relative">
          <button onClick={() => setIsProfileMenuOpen(!isProfileMenuOpen)}>
            <div className="w-[56px] h-[56px] rounded-full border-[3px] border-[#d06224] flex items-center justify-center">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
                <path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" stroke="#d06224" strokeWidth="2"/>
                <path d="M4 22C4 18.6863 7.58172 16 12 16C16.4183 16 20 18.6863 20 22" stroke="#d06224" strokeWidth="2"/>
              </svg>
            </div>
          </button>
          {isProfileMenuOpen && (
      ...
      <main className="ml-[110px] flex-1">
        <div className="h-[90px] bg-white shadow-sm flex items-center px-10">
          <h1 className="text-[28px] font-semibold text-[#d06224]">Bahan Lengkap</h1>
        </div>
        ...
        <div className="px-7 py-5">
          <div className="flex items-center gap-5 mb-5">
            ...
            <button onClick={() => navigate("/resep")} className="h-[40px] px-10 rounded-full bg-[#9f9b4a] text-white font-medium">
              Semua Resep
            </button>
            <button className="h-[40px] px-12 rounded-full bg-[#9f9b4a] text-white font-medium">
              Cepat
            </button>
          </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-5 gap-3">
              {allMenus.map((menu) => <RecipeCard key={menu.id} recipe={menu} />)}
            </div>
          </section>
        </div>
      </main>
