...
export default function ArticlePage() {
  ...
  return (
    <div className="flex flex-col sm:flex-row min-h-screen bg-[#f4f4f4]">
      ...
      {/* MAIN */}
      <main className="flex-1 sm:ml-[110px] flex flex-col overflow-hidden min-w-0 pb-16 sm:pb-0">
        {/* HEADER */}
        <div className="relative bg-gradient-to-br from-[#d06224] via-[#c8571f] to-[#ae431e] px-7 pt-8 pb-6 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 relative z-10">
            <div>
              <p className="text-white/70 text-sm font-light">Wawasan seputar food waste Indonesia</p>
              <h1 className="text-white text-2xl font-semibold mt-0.5">Artikel Food Waste</h1>
            </div>
        ...
        {/* CONTENT */}
        <div className="px-4 md:px-7 py-6 flex flex-col gap-6 overflow-auto">
          {filtered.length === 0 ? (
            ...
            <>
              ...
              {featured && !searchQuery && (
                <section>
                  ...
                  >
                    <div className="h-[220px] bg-gradient-to-br from-[#f5c5a0] to-[#d06224]" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/30 to-transparent" />
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold"
                          style={{ background: CAT_COLORS[featured.category]?.bg ?? "#fff3eb", color: CAT_COLORS[featured.category]?.text ?? "#d06224" }}>
                          {featured.category}
                        </span>
