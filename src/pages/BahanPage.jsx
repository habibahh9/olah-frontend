    ...
    <div className="flex min-h-screen bg-[#f4f4f4]">
      ...
      <main className="ml-[110px] flex-1">
        ...
        <div className="flex items-center gap-5 mb-5">
          ...
          <button
            onClick={handleSort}
            className={`h-[40px] px-10 rounded-full text-white font-Regular flex items-center gap-2 transition-colors
          ...
          >
            ...
            {sortOrder === "asc" ? "Urutkan" : sortOrder === "desc" ? "Urutkan" : "Urutkan"}
          </button>

          <button
            onClick={() => navigate("/tambah-item")}
            className="h-[40px] px-10 rounded-full bg-[#d06224] text-white font-Regular flex items-center gap-2"
          >
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <div className="flex flex-wrap gap-6">
              {filteredCategories.flatMap((category) => category.items).map((item) => (
                <div
                  key={item.id}
                  className="w-[185px] rounded-xl overflow-hidden bg-white hover:shadow-md transition-shadow shadow-sm border border-gray-200"
                >
