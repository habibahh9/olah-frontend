...
export default function DetailResepPage() {
  ...
  const recipe = {
    ...
    ingredients: [                
      { name: "Tahu Putih",   amount: "6 buah", inCart: false },
      { name: "Bayam",        amount: "1 ikat",  inCart: false },
      { name: "Cabe Merah",   amount: "3 buah", inCart: false },
      { name: "Bawang Putih", amount: "2 buah", inCart: false },
      { name: "Bombay",       amount: "1 buah", inCart: true  },
      { name: "Saus Tiram",   amount: "1 sdm",  inCart: false },
    ],                            
  };                              
        ...
        <div className="h-[70px] md:h-[90px] bg-white shadow-sm flex items-center px-4 md:px-10">
          <button onClick={() => navigate(-1)} className="mr-4 text-[#d06224] hover:opacity-70">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M15 18L9 12L15 6" stroke="#d06224" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 max-w-[700px]">
              {recipe.ingredients.map((item, index) => (
                <div
                  key={item.name}
                  className={`flex items-center h-10 rounded-[10px] px-4 ${
                    cartItems[index] ? "bg-[#ae431e]" : "bg-white"
                  }`}
                >
                  <span className={`flex-1 text-base font-medium ${cartItems[index] ? "text-white" : "text-[#ae431e]"}`}>
                    {item.name}
                  </span>
                  <span className={`text-base font-semibold mr-4 ${cartItems[index] ? "text-white" : "text-[#8a8635]"}`}>
                    {item.amount}
                  </span>
                  <button
