        ...
        <section className="relative h-[220px] overflow-hidden">
          ...
          <div className="absolute top-3 left-4 right-4 sm:top-[32px] sm:bottom-auto sm:left-auto sm:right-8 sm:w-[300px] flex gap-0">
            <input
              type="search"
              value={searchQuery}
              onChange={(e) => { const v = e.target.value; setSearchQuery(v); setAppliedSearch(v); }}
            ...
            />
            <button type="button" onClick={() => setAppliedSearch(searchQuery.trim())}
        ...
        <div className="px-4 sm:px-7 py-5 flex flex-col gap-6 overflow-hidden">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 w-full">
              {loading ? (
                <div className="col-span-full text-center text-gray-400 py-6">Memuat resep...</div>
                ...
                <div className="col-span-full bg-white rounded-[12px] p-6 text-center text-gray-500">
                  Tidak ditemukan resep atau bahan untuk "<span className="font-semibold text-black">{appliedSearch}</span>"
                </div>
              ) : filteredRecipes.length === 0 ? (
                <div className="col-span-full text-center text-gray-400 py-6">Belum ada resep tersedia.</div>
              ) : (
