...
const [formData, setFormData] = useState(() => {
  try {
    ...
    if (saved) {
      ...
      return {
        namaDepan:     parsed.namaDepan     || parsed.firstName  || "Putri",
        namaBelakang:  parsed.namaBelakang  || parsed.lastName   || "Anisa",
        namaTampilan:  parsed.namaTampilan  || `${parsed.firstName || "Putri"} ${parsed.lastName || "Anisa"}`,
        email:         parsed.email                              || "putrianisacc4@gmail.com",
        bio:           parsed.bio           || "Suka memasak masakan Indonesia dan berusaha mengurangi food waste di rumah.",
      };
    }
  } catch {}
  // fallback default
              ...
              <div className="flex items-center gap-3 py-4">
                <div className="w-9 h-9 rounded-lg bg-[#f5ede6] flex items-center justify-center shrink-0">
                  <svg width="18" height="14" viewBox="0 0 24 20" fill="none">
                    <path d="M21.6 0H2.4C1.08 0 0.012 1.08 0.012 2.4L0 16.8C0 18.12 1.08 19.2 2.4 19.2H21.6C22.92 19.2 24 18.12 24 16.8V2.4C24 1.08 22.92 0 21.6 0ZM21.6 4.8L12 10.8L2.4 4.8V2.4L12 8.4L21.6 2.4V4.8Z" fill="#d06224"/>
                  </svg>
                </div>
                <div>
              ...
              <div className="flex items-center gap-3 py-4">
                <div className="w-9 h-9 rounded-lg bg-[#f0eedb] flex items-center justify-center shrink-0">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    <path d="M19 3H18V1H16V3H8V1H6V3H5C3.89 3 3.01 3.9 3.01 5L3 19C3 20.1 3.89 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM19 19H5V8H19V19ZM7 10H12V15H7V10Z" fill="#8a8635"/>
                  </svg>
                </div>
                <div>
                  <p className="text-xs font-semibold text-[#8a8635]">Bergabung Sejak</p>
                  <p className="text-sm text-gray-600">28 April 2026</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-5">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-[#f5f5f5] rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#d06224]/30"
                  />
                </div>
                <div className="flex-1">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-3 py-2.5 bg-[#f5f5f5] rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#d06224]/30 resize-none"
                />
              </div>
              ...
              <div className="flex justify-end mt-2">
                <button
                  ...
                  className={`px-6 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-200
                    ${saved ? "bg-[#8a8635]" : "bg-[#d06224] hover:bg-[#ae431e] active:scale-95"}`}
                >
