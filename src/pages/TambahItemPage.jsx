...
export default function TambahItemPage() {
  ...
  const handleTambah = async () => {
    if (!namaBahan.trim() || !berat.trim() || !tanggal) return;
    setError("");
    setLoading(true);
    try {
      ...
      setError(err.message || "Gagal menambah bahan. Coba lagi.");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="w-full max-w-[620px] bg-white rounded-[20px] shadow-sm overflow-hidden">
            ...
            <div className="px-6 pt-5 pb-4 border-b border-gray-100">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-[14px] bg-[#f5ede7] flex items-center justify-center shrink-0">
                  <svg width="28" height="28" viewBox="0 0 47 53" fill="none">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400">Tambah Bahan Baru</p>
                </div>
              </div>
            </div>
            ...
            <div className="px-6 py-5 flex flex-col gap-5">
              ...
              <div className="flex gap-5 items-start">
                <div className="flex flex-col items-center gap-1.5 shrink-0">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-[120px] h-[120px] rounded-[14px] border-2 border-[#d06224] flex flex-col items-center justify-center gap-2 overflow-hidden bg-[#fdf7f4] hover:bg-[#faeee6] transition"
                    >
                      {imagePreview ? (
                        <img src={imagePreview} alt="preview" className="w-full h-full object-cover" />
                      ) : (
                        <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                          <path d="M23 19C23 19.5304 22.7893 20.0391 22.4142 20.4142C22.0391 20.7893 21.5304 21 21 21H3C2.46957 21 1.96086 20.7893 1.58579 20.4142C1.21071 20.0391 1 19.5304 1 19V8C1 7.46957 1.21071 6.96086 1.58579 6.58579C1.96086 6.21071 2.46957 6 3 6H7L9 3H15L17 6H21C21.5304 6 22.0391 6.21071 22.4142 6.58579C22.7893 6.96086 23 7.46957 23 8V19Z" stroke="#d06224" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                          <circle cx="12" cy="13" r="4" stroke="#d06224" strokeWidth="1.8" />
                          <path d="M12 10V16M9 13H15" stroke="#d06224" strokeWidth="1.5" strokeLinecap="round" />
                        </svg>
                      )}
                    </button>
                    {showImageOptions && (
                    <div className="absolute top-[125px] left-0 z-30 bg-white rounded-[12px] shadow-xl border border-gray-100 py-1 w-[150px]">
                      ...
                      >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                          <rect x="3" y="3" width="18" height="18" rx="2" stroke="#555" strokeWidth="1.8"/>
                      ...
                      >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                          <path d="M23 19C23 19.5304 22.7893 20.0391 22.4142 20.4142C22.0391 20.7893 21.5304 21 21 21H3C2.46957 21 1.96086 20.7893 1.58579 20.4142C1.21071 20.0391 1 19.5304 1 19V8C1 7.46957 1.21071 6.96086 1.58579 6.58579C1.96086 6.21071 2.46957 6 3 6H7L9 3H15L17 6H21C21.5304 6 22.0391 6.21071 22.4142 6.58579C22.7893 6.96086 23 7.46957 23 8V19Z" stroke="#555" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                          <circle cx="12" cy="13" r="4" stroke="#555" strokeWidth="1.8"/>
                        </svg>
                        Buka Kamera
                      </button>
                      ...
                      {imagePreview && (
                        <>
                          <hr className="my-1"/>
                          <button
                            onClick={() => { setImagePreview(null); setShowImageOptions(false); }}
                ...
                <div className="flex-1 flex flex-col gap-1.5 pt-1">
                  ...
                  <input
                    ...
                    className="w-full h-[42px] rounded-[10px] bg-[#f4f4f4] px-4 text-sm text-gray-700 placeholder-gray-400 outline-none focus:ring-2 focus:ring-[#d06224]/30"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex gap-2">
                  <input
                    type="number"
                    placeholder="Masukkan Berat/Jumlah"
                    value={berat}
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="h-[42px] px-5 bg-[#9f9b4a] text-white text-sm font-medium rounded-[10px] flex items-center gap-1.5 hover:bg-[#8a8635] transition"
                    >
                      {satuan}
                      <svg width="10" height="6" viewBox="0 0 10 6" fill="none"><path d="M1 1L5 5L9 1" stroke="white" strokeWidth="1.5" strokeLinecap="round" /></svg>
                    </button>
                    {showSatuanDropdown && (
                      <div className="absolute right-0 top-[46px] z-30 bg-white rounded-[12px] shadow-xl border border-gray-100 py-1 w-[110px]">
                        {satuanOptions.map((s) => (
                          <button key={s} onClick={() => { setSatuan(s); setShowSatuanDropdown(false); }}
                            className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 ${satuan === s ? "text-[#d06224] font-semibold" : "text-gray-700"}`}>
                            {s}
                          </button>
                        ))}
                      </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-2 h-[42px] bg-[#f4f4f4] rounded-[10px] px-4 w-fit">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                    <rect x="3" y="4" width="18" height="18" rx="2" stroke="#d06224" strokeWidth="1.8" />
                    <path d="M3 9H21M8 2V6M16 2V6" stroke="#d06224" strokeWidth="1.8" strokeLinecap="round" />
                  </svg>
                  <input
                    type="date"
                    value={tanggal}
              ...
              <button
                ...
                disabled={!namaBahan.trim() || !berat.trim() || !tanggal || loading}
                className="w-full h-[50px] bg-[#d06224] text-white text-base font-semibold rounded-[12px] hover:bg-[#b85520] transition disabled:opacity-40 disabled:cursor-not-allowed mt-1"
              >
