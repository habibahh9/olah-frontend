...
export default function TambahItemPage() {
  ...
  const handleTambah = () => {
    ...
    const daysLabel = diff > 0 ? `${diff} Hari` : "Kadaluarsa";
    ...
    try {
      ...
      const itemsMap = saved
        ? JSON.parse(saved)
        : { sayuran: [], protein: [], lainnya: [] };

      if (!itemsMap["lainnya"]) itemsMap["lainnya"] = [];
      itemsMap["lainnya"].push({ ...newItem, kategori: undefined });
  ...
  return (
    <div className="flex min-h-screen bg-[#f4f4f4]">
      ...
      <main className="ml-[110px] flex-1 flex flex-col min-h-screen">
        ...
        {/* HEADER */}
        <div className="h-[90px] bg-white shadow-sm flex items-center px-10 gap-4">
          <button
        ...
        {/* CONTENT */}
        <div className="flex-1 flex items-start justify-center px-10 py-10">
            ...
            <div className="px-6 py-5 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex gap-2">
                  <input
                    type="number"
                    placeholder="Masukkan Berat/Jumlah Bahan"
                    value={berat}
                    ...
                    {showSatuanDropdown && (
                      <div className="absolute right-0 top-[46px] z-30 bg-white rounded-[12px] shadow-xl border border-gray-100 py-1 w-[110px]">
                        {satuanOptions.map((s) => (
                          <button
                            key={s}
                            onClick={() => { setSatuan(s); setShowSatuanDropdown(false); }}
                            className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 ${
                              satuan === s ? "text-[#d06224] font-semibold" : "text-gray-700"
                            }`}
                          >
                            {s}
                          </button>
