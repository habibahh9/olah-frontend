            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 h-[42px] rounded-l-full px-5 bg-white outline-none text-sm min-w-0"
                />
                <button className="w-[48px] h-[42px] shrink-0 rounded-r-full bg-[#d06224] flex items-center justify-center">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-none" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
                {filterOptions.map((opt) => (
                  <button
                    ...
                    className={`h-[38px] px-5 rounded-full text-sm font-medium transition shrink-0 ${
                      filter === opt
                        ? "bg-[#9f9b4a] text-white"
