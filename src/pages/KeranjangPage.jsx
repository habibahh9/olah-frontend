...
export default function KeranjangPage() {
  ...
  const tambahItem = () => {
    ...
    setItems((prev) => [
      ...prev,
      { id: Date.now(), name: newItemName.trim(), checked: false, resep: null },
    ]);
    setNewItemName("");
    ...
    <div className="flex min-h-screen bg-[#f4f4f4]">
      ...
      <main className="ml-[110px] flex-1 flex flex-col min-h-screen">
        ...
        <div className="h-[90px] bg-white shadow-sm flex items-center justify-between px-10">
          <h1 className="text-[28px] font-bold text-[#d06224]">Daftar Belanja</h1>
          <button
            onClick={hapusSelesai}
            className="h-[46px] px-8 bg-[#d06224] text-white font-semibold text-base rounded-[15px] hover:bg-[#b85520] transition"
          >
            Hapus Item Selesai
          </button>
        </div>
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { label: "Sudah Beli", value: sudahBeli, color: "text-[#a0a0a0]" },
                { label: "Belum Beli", value: belumBeli, color: "text-[#d06224]" },
              ].map((stat) => (
                <div key={stat.label} className="bg-white rounded-[15px] flex flex-col items-center justify-center py-6 shadow-sm">
            ...
            {/* SEARCH */}
            <div className="bg-white rounded-[15px] flex items-center px-5 gap-3 shadow-sm h-[56px]">
              <input
                type="text"
              ...
              />
              <button className="w-10 h-10 bg-[#d06224] rounded-[10px] flex items-center justify-center shrink-0">
            ...
            <div className="bg-white rounded-[15px] shadow-sm overflow-hidden">
              {filtered.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-gray-300">
                  <svg width="48" height="48" viewBox="0 0 44 49" fill="none" className="mb-3 opacity-40">
                ...
                filtered.map((item, idx) => (
                  ...
                  >
                    ...
                    {/* Name + label sudah beli */}
                    <div className="flex-1 flex items-center gap-2" onClick={() => toggleItem(item.id)} style={{cursor:"pointer"}}>
                      <span
                      ...
                      {item.checked && (
                        <span className="text-xs bg-[#f5c5ac] text-[#d06224] font-semibold px-2 py-0.5 rounded-full">
                          Sudah Beli
                        </span>
                      )}
                    </div>
                    ...
                    <button
                      ...
                      className="w-9 h-9 bg-gray-100 rounded-[10px] flex items-center justify-center shrink-0 hover:bg-red-100 hover:text-red-500 text-gray-400 transition"
                    >
                      <svg width="15" height="16" viewBox="0 0 15 16" fill="none">
                        <path d="M1 4H14M5.5 4V2.5C5.5 2.1 5.8 1.5 6.5 1.5H8.5C9.2 1.5 9.5 2.1 9.5 2.5V4M6 7.5V12M9 7.5V12M2 4L2.7 13C2.75 13.8 3.4 14.5 4.2 14.5H10.8C11.6 14.5 12.25 13.8 12.3 13L13 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </button>
                  </div>
                ))
              ...
              {/* Tambah item baru di bawah list */}
              <div
                className="flex items-center gap-4 px-6 py-4 cursor-pointer hover:bg-gray-50 transition border-t border-gray-100"
              ...
              >
                ...
                <span className="flex-1 text-sm text-[#d06224] font-medium">Tambah item baru...</span>
              </div>
            </div>
          </div>

          {/* RIGHT COLUMN — Sumber dari resep */}
          <div className="w-[280px] flex flex-col gap-4 shrink-0">
            <h2 className="text-lg font-normal text-gray-700">Sumber dari resep</h2>
      ...
      {showAddModal && (
        ...
        >
          <div
            className="bg-white rounded-[20px] shadow-2xl p-7 w-[380px] flex flex-col gap-4"
            onClick={(e) => e.stopPropagation()}
          >
            <h3 className="text-lg font-bold text-[#d06224]">Tambah Item</h3>
            <input
              type="text"
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                onClick={tambahItem}
                className="px-5 py-2 rounded-[10px] text-sm text-white bg-[#d06224] hover:bg-[#b85520] transition font-semibold"
              >
                Tambah
              </button>
            </div>
