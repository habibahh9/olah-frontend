      ...
      <div className="flex min-h-screen bg-[#f4f4f4]">
        ...
        <aside className="fixed left-0 top-0 w-[110px] h-screen bg-white shadow-lg flex flex-col items-center py-5 gap-7 z-50">
          <img
            src={logoOlah}
            alt="OLAH Logo"
            className="w-14 object-contain mb-1"
          />
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {item.icon}
                <span className="leading-tight">{item.label}</span>   {/* ← tambah leading-tight */}
              </button>
            );
          })}
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-5 gap-3">
                {filteredFavoriteMenus.length > 0 ? (
                  ...
                  <div className="col-span-5 text-center text-sm text-gray-500 py-10">
