...
export default function SandiPage() {
  ...
  const namaLengkap = savedProfile.namaTampilan
    || `${savedProfile.firstName || ""} ${savedProfile.lastName || ""}`.trim()
    || "PUTRI ANISA";

  const emailProfil = savedProfile.email || "putrianisacc4@gmail.com";
  const bioProfil   = savedProfile.bio   || "Suka memasak masakan Indonesia dan berusaha mengurangi food waste di rumah.";
            ...
            <div className="w-full flex flex-col gap-0 divide-y divide-gray-100">
              <div className="flex items-center gap-3 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{emailProfil}</p>
                </div>
              </div>
